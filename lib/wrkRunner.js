...
module.exports = {
                                ...
                                return Promise.each(config.messageLengths, messageLength => {
                                    ...
                                    return Promise.each(images, (image, i) => {
                                        ...
                                        return Promise.resolve()
                                            ...
                                            .then(results => this._writeResultsToFile(delay, keepAlive, compression, connections, messageLength, image, results))
                                            .then(() => {
     ...
     * @private
     */
    _writeResultsToFile(delay, keepAlive, compression, connections, messageLength, image, results) {
        return Promise.resolve()
            ...
            .then(data => {
                ...
                const i = _.findIndex(allResults, { delay, keepAlive, compression, connections, messageLength, image });
                if (i >= 0) {
                    allResults[i] = entry;
                } else {
